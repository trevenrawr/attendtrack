...
CREATE TABLE IF NOT EXISTS teachers (
    ...
    PDC_notes TEXT,
	PECT_status ENUM('inactive', 'active', 'certified'),
	PECT_date DATE,
	PECT_disc_spec SMALLINT,
	PECT_disc_spec_who VARCHAR(127),
	PECT_obser_who VARCHAR(127),
	PECT_obser_date DATE,
	PECT_reflection_status ENUM('incomplete', 'in review', 'accepted'),
	PECT_reflection_date DATE,
	PECT_survey_status ENUM('not sent', 'sent', 'completed'),
	PECT_survey_date DATE,
	PECT_notes TEXT,
